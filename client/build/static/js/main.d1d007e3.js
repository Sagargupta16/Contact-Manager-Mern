/*! For license information please see main.d1d007e3.js.LICENSE.txt */
!(function () {
  var e = {
      569: function (e, t, n) {
        e.exports = n(36);
      ...
      463: function (e, t, n) {
        ...
        function Qo(e, t, n, r) {
          ...
          "object" === typeof o && null !== o
            ? (a.context = _o(o))
            : ((o = Ra(t) ? La : Pa.current), (a.context = Ta(e, o))),
        ...
        var li = {
          ...
          ui = {
            ...
            useDebugValue: Yl,
            useDeferredValue: function (e) {
              return Gl(Nl(), vl.memoizedState, e);
            },
            useTransition: function () {
          ...
          if (null !== (l = e.memoizedState) && null !== (r = l.dehydrated))
            return (function (e, t, n, r, a, l, i) {
              ...
              if (((u = 0 !== (i & e.childLanes)), wi || u)) {
                ...
                return ms(), Ai(e, t, i, (r = fi(Error(o(421)))));
              }
              return "$?" === a.data
                ? ((t.flags |= 128),
                  (t.child = e.child),
        ...
        function vs(e, t) {
          ...
          if ((So(), (Pu = n), (Cu.current = r), null !== Lu))
            throw Error(o(261));
        ...
        function zs(e, t, n, r, a, l) {
          ...
          if (((r = e), "function" === typeof e)) Rs(e) && (i = 1);
            ...
            e: switch (e) {
              ...
              case O:
                return (
                  ((e = Ts(13, n, t, a)).elementType = O), (e.lanes = l), e
                );
              case L:
                return (
                  ((e = Ts(19, n, t, a)).elementType = L), (e.lanes = l), e
                );
              case j:
                return Fs(n, a, l, t);
              default:
        ...
        function Hs(e, t, n, r) {
          ...
          return (
            ...
            null !== (e = Do(a, t, l)) && (ns(e, a, l, o), Fo(e, a, l)),
            l
          );
        }
        function Ws(e) {
  ...
  (n.n = function (e) {
    ...
    (function () {
      ...
      var E = (0, t.createContext)({ outlet: null, matches: [] });
      function C(e, t) {
      ...
      function N(e, t, n, r) {
        return (
          ...
          e.forEach(function (e, a) {
            ...
            var l = D([r, o.relativePath]),
              i = n.concat(o);
            e.children &&
              e.children.length > 0 &&
              (!0 === e.index && C(!1), N(e.children, t, i, l)),
              (null != e.path || e.index) &&
                t.push({ path: l, score: L(l, e.index), routesMeta: i });
          }),
          t
        );
      }
        ...
        var u = (function (e, t) {
          ...
          var n = "string" === typeof e ? k(e) : e,
            ...
            u = r
              ...
              : t;
          return { pathname: u, search: M(o), hash: I(i) };
        })(a, r);
        return (
          o &&
            "/" !== o &&
      ...
      function B() {
        return U() || C(!1), (0, t.useContext)(x).location;
      }
      function $() {
        U() || C(!1);
      ...
      function V(e) {
        var n = (0, t.useContext)(E).matches,
          r = B().pathname,
          a = JSON.stringify(
            n.map(function (e) {
              return e.pathnameBase;
        ...
        return (
          ...
          null == e
            ...
            : e.reduceRight(function (r, a, o) {
                return (0, t.createElement)(E.Provider, {
        ...
        var m = i,
          ...
          L = (0, t.useMemo)(
            function () {
              ...
              return null == e
                ? null
                : { pathname: e, search: b, hash: E, state: N, key: O };
            },
            [p, g, b, E, N, O],
          );
        return null == L
      ...
      function q(e) {
        ...
        return (function (e, n) {
          ...
          var f = r.pathname || "/",
            d = _(e, { pathname: "/" === i ? f : f.slice(i.length) || "/" });
          return H(
            d &&
              d.map(function (e) {
      ...
      function G(n) {
        ...
        null == l.current &&
          (l.current = (function (t) {
            ...
            null == s &&
              ((s = 0), a.replaceState(p({}, a.state, { idx: s }), ""));
            var P = {
              get action() {
                return i;
              },
              ...
              block: function (e) {
                var t = d.push(e);
                return (
                  1 === d.length && r.addEventListener(m, g),
                  function () {
                    t(), d.length || r.removeEventListener(m, g);
                  }
                );
              },
            };
        ...
        var i = l.current,
          u = d((0, t.useState)({ action: i.action, location: i.location }), 2),
          s = u[0],
          c = u[1];
        return (
          (0, t.useLayoutEffect)(
        ...
        re = function () {
          return (0, ne.jsx)("div", {
            ...
            children: (0, ne.jsx)("div", {
              ...
              children: (0, ne.jsx)("h2", { children: "Contact Manager" }),
            }),
          });
        };
      function ae(e, t) {
      ...
      var de = (function (e) {
          ...
          function n() {
            ...
            return (
              ...
              (e.add = function (t) {
                t.preventDefault(),
                  "" !== e.state.name && "" !== e.state.email
                    ? (e.props.addContactHandler(e.state),
                      e.setState({ name: "", email: "" }))
        ...
        he = (function (e) {
          ...
          function n(e) {
            var r;
            ae(this, n),
              ((r = t.call(this, e)).update = function (e) {
                e.preventDefault(),
                  "" !== r.state.name && "" !== r.state.email
                    ? (r.props.updateContactHandler(r.state),
                      r.setState({ _id: "", name: "", email: "" }))
                    : alert("All Field are Mandatory");
              });
            var a = window.location,
              o = a.pathname.substring(a.pathname.lastIndexOf("/") + 1),
              l = e.contacts.find(function (e) {
                return e._id === o;
              }),
              i = l.name,
              u = l.email;
            return (r.state = { _id: o, name: i, email: u }), r;
          }
          return (
            le(n, [
              {
            ...
            children: [
              ...
              (0, ne.jsx)(Z, {
                ...
                children: (0, ne.jsxs)("div", {
                  className: "content",
                  children: [
                    (0, ne.jsx)("div", { className: "item-name", children: r }),
                    (0, ne.jsx)("div", { className: "item-mail", children: a }),
                  ],
                }),
              }),
              (0, ne.jsx)(Z, {
                to: { pathname: "/edit/".concat(n), id: n },
                children: (0, ne.jsx)("i", {
              ...
              (0, ne.jsx)("i", {
                ...
                onClick: function () {
                  return e.clickHandler(e.contact);
                },
              }),
            ],
          });
        ...
        ve = function (e) {
          var n = (0, t.useRef)(""),
            ...
            a = e.contacts.map(function (e) {
              return (0, ne.jsx)(me, { contact: e, clickHandler: r }, e._id);
            });
          return (0, ne.jsx)("div", {
            children: (0, ne.jsxs)("div", {
                  ...
                  children: (0, ne.jsxs)("div", {
                    ...
                    children: [
                      (0, ne.jsx)("input", {
                        ...
                        value: e.term,
                        onChange: function () {
                          e.searchKeyword(n.current.value);
                        },
                      }),
                      (0, ne.jsx)("i", { className: "fa fa-search" }),
                    ],
                  }),
                }),
                (0, ne.jsx)("div", {
      ...
      function ge() {
        var e = d((0, t.useState)(["fas fa-moon"]), 2),
          n = e[0],
          r = e[1],
          a = d(
            (0, t.useState)(
          ...
          (0, t.useEffect)(
            function () {
              localStorage.setItem("darkMode", JSON.stringify(o)),
                "dark" === o
                  ? (document.body.classList.add("dark"), r(["fas fa-sun"]))
              ...
              children: (0, ne.jsx)("i", {
                ...
                onClick: function () {
                  document.body.classList.contains("dark")
                    ? (r("fas fa-sun"), l("light"))
                    : (r("fas fa-moon"), l("dark"));
                },
              }),
            }),
          })
              ...
              children: [
                ...
                (0, ne.jsxs)(q, {
                  children: [
                    (0, ne.jsx)(W, {
                      ...
                      element: (0, ne.jsx)(
                        ...
                        l(
                          ...
                          {},
                          {
                            contacts: i.length < 1 ? n : p,
                            getContactID: g,
                            term: i,
                            searchKeyword: function (e) {
                              if ((s(e), e.length > 0)) {
                                var t = n.filter(function (t) {
                                  return Object.values(t.name + " " + t.email)
                                    .join("")
                                    .toLowerCase()
                    ...
                    (0, ne.jsx)(W, {
                      path: "/add",
                      element: (0, ne.jsx)(pe, { addContactHandler: m }),
                    }),
                    (0, ne.jsx)(W, {
                      path: "/edit/:id",
                      element: (0, ne.jsx)(he, {
                        contacts: n,
                        updateContactHandler: v,
                      }),
                    }),
                    (0, ne.jsx)(W, {
                      path: "/contact/:id",
                      element: (0, ne.jsx)(ye, { contacts: n }),
                    }),
                  ],
                }),
                (0, ne.jsx)(ge, {}),
...
//# sourceMappingURL=main.d1d007e3.js.map
